  ...
  <view class="sk-container">
    ...
    >
      <view class="overview sk-image" style="padding-top: 64px">
        <view class="status sk-transparent sk-text-0-0000-826 sk-text"
          >待收货</view
        >
      </view>
      <view class="shipment">
        <navigator
          class="logistics sk-image sk-pseudo sk-pseudo-circle"
          hover-class="none"
        >
          <view class="message sk-transparent sk-text-14-2857-512 sk-text"
            >小兔兔到了小福家里，请签收</view
          >
          <view class="date sk-transparent sk-text-14-2857-990 sk-text"
            >2023-04-15 23:23:04</view
          >
        </navigator>
        <view class="locate sk-image">
          <view class="user sk-transparent sk-text-14-2857-630 sk-text"
            >苏东坡 13633336666</view
          >
      ...
      <view class="goods">
        <view class="item">
          <navigator class="navigator" hover-class="none">
            ...
            <view class="meta">
              <view
                class="name ellipsis sk-transparent sk-text-14-2857-474 sk-text"
              ...
              <view class="price">
                <view class="actual">
                  ...
                  <text class="sk-transparent sk-text-14-2857-102 sk-text"
                    >68</text
                  >
                </view>
              </view>
          ...
          <navigator class="navigator" hover-class="none">
            ...
            <view class="meta">
              <view
                class="name ellipsis sk-transparent sk-text-14-2857-969 sk-text"
                >KJE金属色系轻量电动车骑行盔男女通用</view
              >
              <view class="type sk-transparent sk-text-22-2222-510 sk-text"
                >玫瑰金L</view
              >
              <view class="price">
                <view class="actual">
                  <text class="symbol sk-transparent sk-opacity">¥</text>
                  <text class="sk-transparent sk-text-14-2857-431 sk-text"
                    >120</text
                  >
                </view>
              </view>
          ...
          <navigator class="navigator" hover-class="none">
            ...
            <view class="meta">
              <view
                class="name ellipsis sk-transparent sk-text-14-2857-130 sk-text"
              ...
              <view class="price">
                <view class="actual">
                  <text class="symbol sk-transparent sk-opacity">¥</text>
                  <text class="sk-transparent sk-text-14-2857-273 sk-text"
                    >289</text
                  >
                </view>
              </view>
        ...
        <view class="total">
          <view class="row">
            <view class="text sk-transparent sk-text-0-0000-302 sk-text"
              >商品总价:
            </view>
            <view
          ...
          <view class="row">
            <view class="text sk-transparent sk-text-0-0000-912 sk-text"
              >运费:
            </view>
            <view
          ...
          <view class="row">
            <view class="text sk-transparent sk-text-0-0000-538 sk-text"
              >应付金额:
            </view>
            <view
      ...
      <view class="detail">
        <view class="title sk-transparent sk-text-0-0000-66 sk-text"
          >订单信息</view
        >
        <view class="row">
          <view class="item sk-transparent">
            订单编号: 1645809639951962113
            <text class="copy sk-transparent sk-text-0-0000-522 sk-text"
              >复制</text
            >
          </view>
